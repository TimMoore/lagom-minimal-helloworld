...
import com.lightbend.lagom.example.hello.impl.HelloCommand.Hello;
import com.lightbend.lagom.example.hello.impl.HelloCommand.UseGreetingMessage;
...
public class HelloServiceImpl implements HelloService {
    ...
    @Override
    public Topic<com.lightbend.lagom.example.hello.api.HelloEvent> helloEvents() {
        ...
        return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
                ...
                persistentEntityRegistry.eventStream(tag, offset).map(eventAndOffset -> {
                    ...
                    com.lightbend.lagom.example.hello.api.HelloEvent eventToPublish;
                    ...
                    if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
                        ...
                        eventToPublish = new com.lightbend.lagom.example.hello.api.HelloEvent.GreetingMessageChanged(
